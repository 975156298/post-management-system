...
# application.js, application.css, and all non-JS/CSS in app/assets folder are already added.
 Rails.application.config.assets.precompile += %w(comment/comment.js comment/comment.css main/main.js main/main.css search.js land/index.js land/index.css land/register.css
